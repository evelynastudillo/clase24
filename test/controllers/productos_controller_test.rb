...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { name: @producto.name, price: @producto.price } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { name: @producto.name, price: @producto.price } }
